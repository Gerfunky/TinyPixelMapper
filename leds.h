...
// defines , DO NOT CHANGE!!!!
		...
		#define MAX_NUM_LEDS   1500 //(2000) //(170*6*3)  		// what is the max it can be set to in the config   850 test old without wifi. 2500 killedWifiAP mode!
		...
		#define _M_NR_FORM_BYTES_  20 //16 // 8				// 2 bytes = 16 forms   // 4 bytes = 32 forms 8=64     16 =128
		#define NR_FORM_PARTS	 160 // 128 //64 				// how many forms? default 6*8 = 64
...
///
		...
		_M_LAYER_128_FFT = 65,
		_M_LAYER_128_PAL = 66,
		_M_LAYER_128_ROTATE = 67,
		_M_LAYER_128_MIRROR = 68,


		_M_LAYER_144_FFT = 69,
		_M_LAYER_144_PAL = 70,
		_M_LAYER_144_ROTATE = 71,
		_M_LAYER_144_MIRROR = 72,
