// here are the old Touch OSC functions  and the strip functions 
// moved them here to clean up the main osc.cpp
// 
...
// Main OSC loop backup copy before move to here
void OSC_loop() 
{	// the main osc loop
